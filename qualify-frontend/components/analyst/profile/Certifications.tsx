...
const certificationsCardsVector: Certification[] = [
  {
    id: 1,
...
function Card({ name, institution, description, year }: Certification) {
  return (
    <div className="flex flex-col mt-4 mb-4">
      ...
      <p className="text-zinc-400 text-sm mb-1">{institution}</p>
      <p className="text-zinc-200 text-base mb-1">{description}</p>
