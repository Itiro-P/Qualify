...
const biografia: string =
  "Meu nome é terterson testersiano, sou de testersian e tenho 8 semanas de experiência, em testes aleatórios e teste de botões, além do mais sou um guardião da qualidade.";
