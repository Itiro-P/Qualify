...
func TestService(t *testing.T) {
	...
	t.Run("Alterando serviço", func(t *testing.T) {
		...
		assert.Equal(t, serviceResponse.Service.Title, newTitle)
		assert.Equal(t, serviceResponse.Service.Content, newContent)
	})

	t.Run("Removendo serviço", func(t *testing.T) {
		targetURL := fmt.Sprintf("/services/%d", service.Id)
