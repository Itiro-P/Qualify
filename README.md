# Qualify
Qualify é uma plataforma que conecta empresas a freelancers especializados em qualidade de software (QA). O sistema permite que organizações publiquem demandas de testes, revisão de qualidade e validação de sistemas, enquanto analistas de QA independentes podem se candidatar, colaborar e entregar relatórios de qualidade diretamente pela plataforma.
